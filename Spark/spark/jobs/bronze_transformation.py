...
def parse_pgn(game):
    ...
    white_diff= None
    if meta.get("WhiteRatingDiff") is not None:
        white_diff = int(meta.get("WhiteRatingDiff"))
    black_diff = None
    if meta.get("BlackRatingDiff") is not None:
        black_diff = int(meta.get("BlackRatingDiff"))
    ...
    result = {
        ...
        "WhiteDiff": white_diff,
        "BlackDiff": black_diff
    }
...
if __name__ == "__main__":
    ...
    schema = StructType([
        ...
        StructField("Result", StructType([
            ...
            StructField("WhiteDiff", IntegerType(), nullable=True),
            StructField("BlackDiff", IntegerType(), nullable=True)
        ])),
